        ...
        <div className="grid min-h-[65vh] items-start gap-10 md:grid-cols-[0.5fr_1.1fr]">
          ...
          <div className="grid gap-6">
            ...
            >
              ...
              <p className="mt-2 text-xs text-slate-300 md:max-h-0 md:overflow-hidden md:opacity-0 md:transition-all md:duration-300 md:group-hover:max-h-16 md:group-hover:opacity-100 md:group-focus-within:max-h-16 md:group-focus-within:opacity-100">
        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_0.8fr]">
          ...
          >
            ...
            <div className="mt-4">
              ...
              <p className="mt-3 text-xs text-slate-300 md:max-h-0 md:overflow-hidden md:opacity-0 md:transition-all md:duration-300 md:group-hover:max-h-16 md:group-hover:opacity-100 md:group-focus-within:max-h-16 md:group-focus-within:opacity-100">
        ...
        <div className="relative">
          ...
          <div className="grid gap-8 md:grid-cols-3 md:gap-10">
            {[
              ...
              <div key={num} className="relative flex gap-4 pl-7 md:flex-col md:items-center md:gap-4 md:pl-0">
                <div className="absolute left-0 top-1/2 z-10 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-white/30 bg-slate-900/70 text-sm font-bold text-white shadow-[0_0_0_5px_rgba(255,255,255,0.04)] backdrop-blur-md md:static md:translate-y-0">
                  {num}
                </div>
